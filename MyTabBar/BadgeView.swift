...
open class BadgeView: UILabel {
    ...
    open var insets: CGSize = CGSize(width: 5, height: 2) {
        didSet {
            invalidateIntrinsicContentSize()
        }
    }
    ...
    open var shadowOpacityBadge: CGFloat = 0.5 {
        didSet {
    ...
    open var shadowRadiusBadge: CGFloat = 0.5 {
        didSet {
    ...
    open var shadowColorBadge: UIColor = UIColor.black {
        didSet {
    ...
    open var shadowOffsetBadge: CGSize = CGSize(width: 0, height: 0) {
        didSet {
